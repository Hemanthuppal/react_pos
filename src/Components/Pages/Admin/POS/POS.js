...
const POS = () => {
  ...
  return (
    <div className="admin-POS-container d-flex">
      <AdminSidebar onToggleSidebar={setCollapsed} />
      <div className={`admin-POS-content flex-grow-1 p-3 ml-3 ${collapsed ? 'collapsed' : ''}`}>
          ...
          <div className="card p-3 mt-0">
            ...
            <div className="row mb-3">
              <div className="col-8">
                ...
                <div style={{ maxHeight: '400px', overflow: 'scroll', whiteSpace: 'nowrap', height: "500px" }}>
